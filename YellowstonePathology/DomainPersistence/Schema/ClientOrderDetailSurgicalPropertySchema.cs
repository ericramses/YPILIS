...
{
	class ClientOrderDetailSurgicalPropertySchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.ClientOrderDetailSurgicalPropertySchema.xsd";
