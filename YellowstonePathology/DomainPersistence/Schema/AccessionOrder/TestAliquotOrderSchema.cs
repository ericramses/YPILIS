...
{
	public class TestAliquotOrderSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.TestAliquotOrderSchema.xsd";
