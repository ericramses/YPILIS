...
{
	public class AmendmentSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.AmendmentSchema.xsd";
