...
{
	public class CptIcd9BillingCodeSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.CptIcd9BillingCodeSchema.xsd";
