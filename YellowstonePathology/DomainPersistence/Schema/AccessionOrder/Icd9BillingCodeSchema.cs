...
{
	public class Icd9BillingCodeSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.Icd9BillingCodeSchema.xsd";
