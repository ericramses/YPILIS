...
namespace YellowstonePathology.Business.Billing.Model
{
	public class BillableObjectStains : BillableObject
    {
        ...
        {            
            YellowstonePathology.Business.Billing.Model.CptCode cpt88360 = Billing.Model.CptCodeCollection.Get("88360", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88313 = Billing.Model.CptCodeCollection.Get("88313", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88312 = Billing.Model.CptCodeCollection.Get("88312", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88344 = Billing.Model.CptCodeCollection.Get("88344", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88342 = Billing.Model.CptCodeCollection.Get("88342", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88341 = Billing.Model.CptCodeCollection.Get("88341", null);
        ...
        public void Post3395F()
        {
            if (this.m_StainSpecimenCollection.Requires3395F() == true)
            {
                ...
                {
                    YellowstonePathology.Business.Billing.Model.PQRSCode pqrs3395F = (PQRSCode)Billing.Model.CptCodeCollection.Get("3395F", null);
                    YellowstonePathology.Business.Test.PanelSetOrderCPTCodeBill panelSetOrderCPTCodeBill = this.m_PanelSetOrder.PanelSetOrderCPTCodeBillCollection.GetNextItem(this.m_PanelSetOrder.ReportNo);
                    panelSetOrderCPTCodeBill.ClientId = this.m_AccessionOrder.ClientId;
        ...
        private void SetERPRPQRSCodes()
        {
            ...
            if (count88360 > 0)
            {
                ...
                {
                    YellowstonePathology.Business.Billing.Model.PQRSCode pqrs3395 = (PQRSCode)Billing.Model.CptCodeCollection.Get("3395F", null);
                    YellowstonePathology.Business.Test.PanelSetOrderCPTCode panelSetOrderCPTCode = this.m_PanelSetOrder.PanelSetOrderCPTCodeCollection.GetNextItem(this.m_PanelSetOrder.ReportNo);                    
                    panelSetOrderCPTCode.Quantity = 1;
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88365 = Billing.Model.CptCodeCollection.Get("88365", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88364 = Billing.Model.CptCodeCollection.Get("88364", null);
