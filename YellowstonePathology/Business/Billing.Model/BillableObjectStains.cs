...
namespace YellowstonePathology.Business.Billing.Model
{
	public class BillableObjectStains : BillableObject
    {
        ...
        {            
            YellowstonePathology.Business.Billing.Model.CptCode cpt88360 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88360");
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88313 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88313");
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88312 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88312");
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88344 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88344");
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88342 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88342");
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88341 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88341");
        ...
        public void Post3395F()
        {
            if (this.m_StainSpecimenCollection.Requires3395F() == true)
            {
                ...
                {
                    YellowstonePathology.Business.Billing.Model.PQRSCode pqrs3395F = (PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:3395F");
                    YellowstonePathology.Business.Test.PanelSetOrderCPTCodeBill panelSetOrderCPTCodeBill = this.m_PanelSetOrder.PanelSetOrderCPTCodeBillCollection.GetNextItem(this.m_PanelSetOrder.ReportNo);
                    panelSetOrderCPTCodeBill.ClientId = this.m_AccessionOrder.ClientId;
        ...
        private void SetERPRPQRSCodes()
        {
            ...
            if (count88360 > 0)
            {
                ...
                {
                    YellowstonePathology.Business.Billing.Model.PQRSCode pqrs3395 = (PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:3395F");
                    YellowstonePathology.Business.Test.PanelSetOrderCPTCode panelSetOrderCPTCode = this.m_PanelSetOrder.PanelSetOrderCPTCodeCollection.GetNextItem(this.m_PanelSetOrder.ReportNo);                    
                    panelSetOrderCPTCode.Quantity = 1;
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88365 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88365");
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cpt88364 = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88364");
