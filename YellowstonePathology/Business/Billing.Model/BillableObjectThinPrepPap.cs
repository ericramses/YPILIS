    ...
    {        
		...
		public override void PostGlobal(string billTo, string billby)
		{
			if (this.IsOkToPost() == true)
			{
				...
				{
					YellowstonePathology.Business.Billing.Model.CptCode cptCode = Business.Billing.Model.CptCodeCollection.Instance.Get(panelSetOrderCPTCode.CPTCode, panelSetOrderCPTCode.Modifier);
        ...
        private void SetPrimaryScreeningCode()
        {
				...
				this.m_PanelSetOrder.PanelSetOrderCPTCodeCollection.Exists("88142", 1) == false)
			{
				...
				{
                    cptCode = Billing.Model.CptCodeCollection.Instance.Get("88175", null);                    
				}
				else
				{
                    cptCode = Billing.Model.CptCodeCollection.Instance.Get("88142", "52");
				}
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cptCode = Billing.Model.CptCodeCollection.Instance.Get("88141", null);
