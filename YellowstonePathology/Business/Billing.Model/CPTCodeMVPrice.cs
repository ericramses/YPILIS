...
namespace YellowstonePathology.Business.Billing.Model
{
    public class CPTCodeMVPrice
    {
        ...
        public CPTCodeMVPrice()
        {
            ...
            this.m_CPTCodePriceList.Add(new CPTCodePrice(Billing.Model.CptCodeCollection.GetCPTCode("88184"), "YPI", "Client", 29.50));
            this.m_CPTCodePriceList.Add(new CPTCodePrice(Billing.Model.CptCodeCollection.GetCPTCode("88185"), "YPI", "Client", 29.50));
        }
    }
}
