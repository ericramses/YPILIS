...
namespace YellowstonePathology.Business.Billing.Model
{
    ...
    {        
            ...
            : base(accessionOrder, reportNo)
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCodeCPT81275 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Instance.Get("81275", null), 1);
            ...
            {                
                YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCodeCPT81210 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Instance.Get("81210", null), 1);
		...
		public override void PostTechnical(string billTo, string billby)
		{
			if (this.IsOkToPost() == true)
			{
				...
				foreach (YellowstonePathology.Business.Test.PanelSetOrderCPTCode panelSetOrderCPTCode in panelSetOrderCPTCodeSummaryCollection)
				{
					YellowstonePathology.Business.Billing.Model.CptCode cptCode = CptCodeCollection.Instance.Get(panelSetOrderCPTCode.CPTCode, panelSetOrderCPTCode.Modifier);
