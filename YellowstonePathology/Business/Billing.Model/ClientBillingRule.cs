...
namespace YellowstonePathology.Business.Billing.Model
{
    public class ClientBillingRule : DomainBillingRule
    {
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cptCode = Business.Billing.Model.CptCodeCollection.Get(cptBillingCode.CptCode, cptBillingCode.Modifier);
