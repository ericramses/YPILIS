        ...
        public override void SetPanelSetOrderCPTCodes()
        {
            ...
            if (panelSetOrderLeukemiaLymphoma.FlowMarkerCollection.Count > 0)
			{
				if (this.m_PanelSetOrder.PanelSetOrderCPTCodeCollection.Exists("88184", 1) == false)
				{
                    ...
                    YellowstonePathology.Business.Billing.Model.CptCode cpt88184 = Billing.Model.CptCodeCollection.GetCPTCode("88184", null);
                    ...
                    YellowstonePathology.Business.Billing.Model.CptCode cpt88185 = Billing.Model.CptCodeCollection.GetCPTCode("88185", null);
					...
					{
                        YellowstonePathology.Business.Billing.Model.CptCode cpt88187 = Billing.Model.CptCodeCollection.GetCPTCode("88187", null);
					...
					{
                        YellowstonePathology.Business.Billing.Model.CptCode cpt88188 = Billing.Model.CptCodeCollection.GetCPTCode("88188", null);
					...
					{
                        YellowstonePathology.Business.Billing.Model.CptCode cpt88189 = Billing.Model.CptCodeCollection.GetCPTCode("88189", null);
