        ...
        public override void SetPanelSetOrderCPTCodes()
        {
            ...
            if (panelSetOrderLeukemiaLymphoma.FlowMarkerCollection.Count > 0)
			{
				if (this.m_PanelSetOrder.PanelSetOrderCPTCodeCollection.Exists("88184", 1) == false)
				{
                    ...
                    YellowstonePathology.Business.Billing.Model.CptCode cpt88184 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("88184", null);
                    ...
                    YellowstonePathology.Business.Billing.Model.CptCode cpt88185 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("88185", null);
					...
					{
                        YellowstonePathology.Business.Billing.Model.CptCode cpt88187 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("88187", null);
					...
					{
                        YellowstonePathology.Business.Billing.Model.CptCode cpt88188 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("88188", null);
					...
					{
                        YellowstonePathology.Business.Billing.Model.CptCode cpt88189 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("88189", null);
