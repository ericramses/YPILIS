...
namespace YellowstonePathology.Business.Billing.Model
{
    public class BillableObjectMedicareProstateNeedleBiopsy : BillableObject
    {
        ...
        {
            CptCode cpt88305 = CptCodeCollection.GetCPTCode("88305", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cptG0416 = CptCodeCollection.GetCPTCode("G0416", null);
