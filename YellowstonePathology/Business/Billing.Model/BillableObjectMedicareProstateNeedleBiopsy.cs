...
namespace YellowstonePathology.Business.Billing.Model
{
    public class BillableObjectMedicareProstateNeedleBiopsy : BillableObject
    {
        ...
        {
            CptCode cpt88305 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("88305", null);
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode cptG0416 = Business.Billing.Model.CptCodeCollection.Instance.GetClone("G0416", null);
