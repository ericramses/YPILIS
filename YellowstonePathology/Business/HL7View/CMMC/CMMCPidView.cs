...
namespace YellowstonePathology.Business.HL7View.CMMC
{
	...
	{        		
        ...
        public CMMCPidView(string patientId, string lastName, string firstName, Nullable<DateTime> birthdate, string sex, string patientAccountNumber, string ssn)
        {
