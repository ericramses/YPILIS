...
namespace YellowstonePathology.Business.HL7View.EPIC
{
    public class EPICFT1ResultView : IResultView
    {
        ...
        {            
            ...
            this.m_CptCode = Business.Billing.Model.CptCodeCollection.Instance.GetClone(this.m_PanelSetOrderCPTCodeBill.CPTCode, this.m_PanelSetOrderCPTCodeBill.Modifier);
