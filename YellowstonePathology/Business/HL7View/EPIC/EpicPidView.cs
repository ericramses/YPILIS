...
namespace YellowstonePathology.Business.HL7View
{
	...
	{        		
        ...
        public EpicPidView(string patientId, string lastName, string firstName, Nullable<DateTime> birthdate, string sex, string patientAccountNumber, string ssn)
        {
