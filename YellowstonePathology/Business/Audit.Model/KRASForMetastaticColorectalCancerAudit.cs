...
{
    public class KRASForMetastaticColorectalCancerAudit : Audit
    {
        ...
        public KRASForMetastaticColorectalCancerAudit(YellowstonePathology.Business.Test.AccessionOrder accessionOrder)
        {
        ...
        public override void Run()
        {
            ...
            YellowstonePathology.Business.Test.KRASStandard.KRASStandardTest krasStandardTest = new Test.KRASStandard.KRASStandardTest();
            if (this.m_AccessionOrder.PanelSetOrderCollection.Exists(krasStandardTest.PanelSetId) == false)
            {
                ...
                if (this.IndicatorExists(surgicalTestOrder.Comment))
                {
                    ...
                    this.m_Message.Append(krasStandardTest.PanelSetName);
                }
                else
                {
