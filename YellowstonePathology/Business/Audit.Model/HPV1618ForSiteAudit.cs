...
namespace YellowstonePathology.Business.Audit.Model
{
    public class HPV1618ForSiteAudit : Audit
    {
        ...
        public HPV1618ForSiteAudit(YellowstonePathology.Business.Test.AccessionOrder accessionOrder)
        {
            ...
            this.m_CptCodeCollection = new Billing.Model.CptCodeCollection { Billing.Model.CptCodeCollection.GetCPTCode("88304", null),
                Billing.Model.CptCodeCollection.GetCPTCode("88305", null),
                Billing.Model.CptCodeCollection.GetCPTCode("88307", null),
                Billing.Model.CptCodeCollection.GetCPTCode("88309", null),
                Billing.Model.CptCodeCollection.GetCPTCode("88173", null) };
        }
