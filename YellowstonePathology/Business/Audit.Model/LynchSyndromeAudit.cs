...
namespace YellowstonePathology.Business.Audit.Model
{
    public class LynchSyndromeAudit : Audit
    {
        ...
        public LynchSyndromeAudit(YellowstonePathology.Business.Test.AccessionOrder accessionOrder)
        {
            ...
            this.m_ColorectalCptCodeCollection.Add(Billing.Model.CptCodeCollection.Instance.Get("88309", null));
            ...
            this.m_EndometrialCptCodeCollection.Add(Billing.Model.CptCodeCollection.Instance.Get("88305", null));
            ...
            this.m_UterineCptCodeCollection.Add(Billing.Model.CptCodeCollection.Instance.Get("88309", null));
        }
