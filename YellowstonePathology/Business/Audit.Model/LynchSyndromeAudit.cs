...
namespace YellowstonePathology.Business.Audit.Model
{
    public class LynchSyndromeAudit : Audit
    {
        ...
        public LynchSyndromeAudit(YellowstonePathology.Business.Test.AccessionOrder accessionOrder)
        {
            ...
            this.m_ColorectalCptCodeCollection.Add(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT88309"));
            ...
            this.m_EndometrialCptCodeCollection.Add(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT88305"));
            ...
            this.m_UterineCptCodeCollection.Add(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT88309"));
        }
