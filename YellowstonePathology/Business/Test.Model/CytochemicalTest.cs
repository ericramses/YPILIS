...
namespace YellowstonePathology.Business.Test.Model
{
    ...
    {        
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode result = Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT88313");
            if (isTechnicalOnly == true)
            {
                result = Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT88313TC");
            }
            return result;            
        }        
