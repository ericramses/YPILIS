...
namespace YellowstonePathology.Business.Test.Model
{
	public class CytochemicalForMicroorganisms : Test
    {
        ...
        {
            YellowstonePathology.Business.Billing.Model.CptCode result = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88312");
            if (isTechnicalOnly == true)
            {
                result = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88312tc");
            }
            return result;   
        }
