...
{
    public class MultiTestDistributionHandlerWHPOnly : MultiTestDistributionHandlerWHP
    {
        public MultiTestDistributionHandlerWHPOnly(YellowstonePathology.Business.Test.AccessionOrder accessionOrder) 
            : base(accessionOrder)
        {
