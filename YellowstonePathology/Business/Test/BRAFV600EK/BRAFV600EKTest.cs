...
namespace YellowstonePathology.Business.Test.BRAFV600EK
{
	public class BRAFV600EKTest : YellowstonePathology.Business.PanelSet.Model.PanelSetMolecularTest
	{
        public BRAFV600EKTest()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("cpt:81210"), 1);
