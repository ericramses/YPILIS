...
{
    public class LSEColonMLH1PMS2Loss4 : LSERule
    {
        public LSEColonMLH1PMS2Loss4()
        {
            ...
            this.m_Interpretation = "Loss of nuclear expression of MLH1 and PMS2 mismatch repair proteins." + Environment.NewLine + 
