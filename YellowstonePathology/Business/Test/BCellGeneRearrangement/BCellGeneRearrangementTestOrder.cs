...
{
	[PersistentClass("tblBCellGeneRearrangementTestOrder", "tblPanelSetOrder", "YPIDATA")]
	public class BCellGeneRearrangementTestOrder : YellowstonePathology.Business.Test.PanelSetOrder
	{
		...
		public BCellGeneRearrangementTestOrder(string masterAccessionNo, string reportNo, string objectId,
