...
namespace YellowstonePathology.Business.Test.BCellEnumeration
{
	...
	public class BCellEnumerationTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public BCellEnumerationTest()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode cpt86356 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:86356"), 1);
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode cpt86355 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:86355"), 1);
