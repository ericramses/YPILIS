...
namespace YellowstonePathology.Business.Test.KRASStandard
{
	public class KRASStandardTest : YellowstonePathology.Business.PanelSet.Model.PanelSetMolecularTest
	{
		public KRASStandardTest()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81275", null), 1);
