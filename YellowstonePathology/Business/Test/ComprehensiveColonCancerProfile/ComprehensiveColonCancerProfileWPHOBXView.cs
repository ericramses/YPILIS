...
{
    public class ComprehensiveColonCancerProfileWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public ComprehensiveColonCancerProfileWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
