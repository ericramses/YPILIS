...
namespace YellowstonePathology.Business.Test.KappaByISHLambdaByISH
{
    public class KappaByISHLambdaByISHTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public KappaByISHLambdaByISHTest()
        {
            this.m_PanelSetId = 278;
            this.m_PanelSetName = "Kappa By ISH/Lambda By ISH";
