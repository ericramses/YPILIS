...
{
	[PersistentClass("tblProthrombinTestOrder", "tblPanelSetOrder", "YPIDATA")]
	public class ProthrombinTestOrder : YellowstonePathology.Business.Test.PanelSetOrder
	{
		...
		public ProthrombinTestOrder(string masterAccessionNo, string reportNo, string objectId,
