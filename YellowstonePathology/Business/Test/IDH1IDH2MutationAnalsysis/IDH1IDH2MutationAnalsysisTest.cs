...
namespace YellowstonePathology.Business.Test.IDH1IDH2MutationAnalsysis
{
    public class IDH1IDH2MutationAnalsysisTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public IDH1IDH2MutationAnalsysisTest()
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode1 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81121", null), 1);
            this.m_PanelSetCptCodeCollection.Add(panelSetCptCode1);

            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81120", null), 1);
