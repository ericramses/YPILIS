...
namespace YellowstonePathology.Business.Test.PDL122C3
{
	public class PDL122C3Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
        public PDL122C3Test()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Get("88360", null), 1);
