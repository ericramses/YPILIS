...
namespace YellowstonePathology.Business.Test.EGFRMutationAnalysis
{
    public class EGFRMutationAnalysisNotDetectedResult : EGFRMutationAnalysisResult
    {
        public EGFRMutationAnalysisNotDetectedResult()
        {
            ...
            this.m_Interpretation = "No mutations were detected in EGFR exons 18-21. There is no evidence of EGFR T790M mutation." +                Environment.NewLine + Environment.NewLine + 
                "Screening for EGFR mutations may help identify patients with tumors that will benefit from the use of EGFR tyrosine kinase " +
                "inhibitors(TKIs).  Mutations may be activating and indicate responsiveness to TKIs or it may be a resistance mutation indicating " +
                "a lack of response to TKIs.  A product indicative of an EGFR mutation was not detected.  This indicates the tumor has a decreased " +
