...
namespace YellowstonePathology.Business.Test.CD1a
{
	public class CD1aTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public CD1aTest()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("88342", null), 1);
