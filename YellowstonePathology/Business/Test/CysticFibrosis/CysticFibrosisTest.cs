...
namespace YellowstonePathology.Business.Test.CysticFibrosis
{
	public class CysticFibrosisTest : YellowstonePathology.Business.PanelSet.Model.PanelSetMolecularTest
	{
		public CysticFibrosisTest()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Get("81220", null), 1);
