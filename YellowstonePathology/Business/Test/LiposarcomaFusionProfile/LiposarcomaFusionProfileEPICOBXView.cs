...
{
    public class LiposarcomaFusionProfileEPICOBXView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public LiposarcomaFusionProfileEPICOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        {
            LiposarcomaFusionProfileTestOrder panelSetOrder = (LiposarcomaFusionProfileTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
            this.AddHeader(document, panelSetOrder, "Liposarcoma Fusion Profile");
