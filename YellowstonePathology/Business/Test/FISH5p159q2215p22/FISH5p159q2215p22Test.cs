...
namespace YellowstonePathology.Business.Test.FISH5p159q2215p22
{
    public class FISH5p159q2215p22Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public FISH5p159q2215p22Test()
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:81401"), 1);
