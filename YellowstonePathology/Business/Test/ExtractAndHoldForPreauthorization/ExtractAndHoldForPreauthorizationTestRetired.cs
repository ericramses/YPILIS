...
{
    public class ExtractAndHoldForPreauthorizationTestRetired : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public ExtractAndHoldForPreauthorizationTestRetired()
        {
            this.m_PanelSetId = 300;
            this.m_PanelSetName = "Extract And Hold For Preauthorization - Retired";
