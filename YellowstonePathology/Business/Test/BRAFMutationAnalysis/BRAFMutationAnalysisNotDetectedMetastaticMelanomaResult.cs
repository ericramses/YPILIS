...
{
    public class BRAFMutationAnalysisNotDetectedMetastaticMelanomaResult : BRAFMutationAnalysisNotDetectedResult
    {
        public BRAFMutationAnalysisNotDetectedMetastaticMelanomaResult()
        {
            ...
            this.m_References = BRAFMutationAnalysisResult.MetastaticMelanomaReference;
        }
    }
}