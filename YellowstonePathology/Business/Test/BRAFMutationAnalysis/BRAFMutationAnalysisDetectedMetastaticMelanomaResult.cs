...
{
    public class BRAFMutationAnalysisDetectedMetastaticMelanomaResult : BRAFMutationAnalysisDetectedResult
    {
        public BRAFMutationAnalysisDetectedMetastaticMelanomaResult()
        {
