...
{
    public class BRAFMutationAnalysisResult : YellowstonePathology.Business.Test.TestResult
    {
        public static string Detected = "BRAF Mutation DETECTED.";
        public static string NotDetected = "BRAF Mutation NOT DETECTED.";
        ...
        public BRAFMutationAnalysisResult()
        {
        ...
        public virtual void SetResults(YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder brafTestOrder)
        {
            ...
            brafTestOrder.Method = this.m_Method;
            brafTestOrder.ReportReferences = this.m_References;
        }

        public virtual void FinalizeResults(YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder panelSetOrder, Business.Test.AccessionOrder accessionOrder)
        {
            panelSetOrder.Finish(accessionOrder);
            panelSetOrder.AssignedToId = Business.User.SystemIdentity.Instance.User.UserId;
        }

        public virtual void UnFinalizeResults(YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder panelSetOrder)
        {
            panelSetOrder.AssignedToId = 0;
            panelSetOrder.Unfinalize();
        }

        //public virtual void AcceptResults(YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder panelSetOrder, YellowstonePathology.Business.Test.PanelOrder panelToAccept, YellowstonePathology.Business.User.SystemIdentity systemIdentity)
        public virtual void AcceptResults(YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder panelSetOrder, YellowstonePathology.Business.User.SystemIdentity systemIdentity)
        {
            panelSetOrder.Accept();
        }

        public virtual void UnacceptResults(YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder panelSetOrder)
        {
            panelSetOrder.Unaccept();
        }

        public static YellowstonePathology.Business.Rules.MethodResult IsOkToFinal(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, YellowstonePathology.Business.Test.BRAFMutationAnalysis.BRAFMutationAnalysisTestOrder brafTestOrder)
        {
            YellowstonePathology.Business.Rules.MethodResult result = brafTestOrder.IsOkToFinalize();
            if (result.Success == true)
            {
                ...
                if (accessionOrder.PanelSetOrderCollection.Exists(krasStandardReflexTest.PanelSetId, brafTestOrder.OrderedOnId, true) == false)
                {
                    if (string.IsNullOrEmpty(brafTestOrder.TumorNucleiPercentage) == true)
                    {
                        result.Success = false;
                        result.Message = "This case cannot be finalized because the Tumor Nuclei Percent is not set.";
                    }
                }
                else if (string.IsNullOrEmpty(brafTestOrder.Result) == true)
                {
                    result.Success = false;
        ...
        public static YellowstonePathology.Business.Rules.MethodResult IsOkToAccept(BRAFMutationAnalysisTestOrder testOrder)
        {
        ...
        public static YellowstonePathology.Business.Rules.MethodResult IsOkToSetResult(BRAFMutationAnalysisTestOrder panelSetOrder)
        {
