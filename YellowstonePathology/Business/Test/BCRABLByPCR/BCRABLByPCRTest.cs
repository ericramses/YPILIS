...
namespace YellowstonePathology.Business.Test.BCRABLByPCR
{
	public class BCRABLByPCRTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public BCRABLByPCRTest()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode1 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81206", null), 1);
            this.m_PanelSetCptCodeCollection.Add(panelSetCptCode1);

            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81207", null), 1);
