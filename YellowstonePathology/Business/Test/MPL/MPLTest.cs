...
namespace YellowstonePathology.Business.Test.MPL
{
	public class MPLTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public MPLTest()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:81402"), 1);
