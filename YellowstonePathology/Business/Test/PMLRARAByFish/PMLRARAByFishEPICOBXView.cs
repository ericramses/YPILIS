...
{
    public class PMLRARAByFishEPICOBXView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public PMLRARAByFishEPICOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
