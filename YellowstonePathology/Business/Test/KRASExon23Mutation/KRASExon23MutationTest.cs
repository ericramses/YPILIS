...
namespace YellowstonePathology.Business.Test.KRASExon23Mutation
{
	public class KRASExon23MutationTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public KRASExon23MutationTest()
		{
			...
			this.m_PanelSetCptCodeCollection.Add(new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT81275"), 1));
            this.m_PanelSetCptCodeCollection.Add(new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT81276"), 1));
