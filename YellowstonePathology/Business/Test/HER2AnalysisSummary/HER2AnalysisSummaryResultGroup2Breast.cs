...
{
    public class HER2AnalysisSummaryResultGroup2Breast : HER2AnalysisSummaryResult
    {
        public HER2AnalysisSummaryResultGroup2Breast(PanelSetOrderCollection panelSetOrderCollection, string reportNo) : base(panelSetOrderCollection, reportNo)
        {
        ...
        public override bool IsAMatch()
        {
            ...
            if (this.m_HER2AnalysisSummaryTestOrder.Indicator == HER2AmplificationByISH.HER2AmplificationByISHIndicatorCollection.BreastIndication &&
                ...
                this.m_HER2AnalysisSummaryTestOrder.AverageHer2NeuSignal < 4.0)
            {
                result = true;
            }
            return result;
