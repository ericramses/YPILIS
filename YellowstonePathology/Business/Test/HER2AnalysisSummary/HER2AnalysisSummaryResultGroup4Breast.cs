...
{
    public class HER2AnalysisSummaryResultGroup4Breast : HER2AnalysisSummaryResult
    {
        public HER2AnalysisSummaryResultGroup4Breast(PanelSetOrderCollection panelSetOrderCollection, string reportNo) : base(panelSetOrderCollection, reportNo)
        {
