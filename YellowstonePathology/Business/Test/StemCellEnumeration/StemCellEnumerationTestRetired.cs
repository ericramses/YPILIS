...
{
    public class StemCellEnumerationTestRetired : YellowstonePathology.Business.PanelSet.Model.FlowCytometry.PanelSetFlowCytometry
    {
        public StemCellEnumerationTestRetired()
        {
            this.m_PanelSetId = 24;
            this.m_PanelSetName = "Stem Cell Enumeration - Retired";
            //this.m_TestId = 12;
