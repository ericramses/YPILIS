...
namespace YellowstonePathology.Business.Test.HSVIII
{
    public class HSVIIITest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public HSVIIITest()
        {
            this.m_PanelSetId = 325;
            this.m_PanelSetName = "HSV I/II";
            this.m_Abbreviation = "HSV I/II";
