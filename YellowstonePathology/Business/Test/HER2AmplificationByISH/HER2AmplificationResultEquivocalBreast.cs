...
namespace YellowstonePathology.Business.Test.HER2AmplificationByISH
{
    public class HER2AmplificationResultEquivocalBreast : HER2AmplificationResultBreast
    {
        ...
        public override bool IsAMatch()
        {
            ...
            {
                if ((this.m_HER2ISH.AverageHer2Chr17SignalAsDouble >= 2.0 && this.m_HER2ISH.AverageHer2NeuSignal < 4.0) ||
                        (this.m_HER2ISH.AverageHer2Chr17SignalAsDouble < 2.0 && this.m_HER2ISH.AverageHer2NeuSignal >= 4.0))
                {
                    result = true;
