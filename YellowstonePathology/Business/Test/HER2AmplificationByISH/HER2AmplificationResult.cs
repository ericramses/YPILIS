...
namespace YellowstonePathology.Business.Test.HER2AmplificationByISH
{
    public class HER2AmplificationResult : INotifyPropertyChanged
    {
        ...
        protected Interface.IHER2ISH m_HER2ISH;
        ...
        public HER2AmplificationResult(PanelSetOrderCollection panelSetOrderCollection, string reportNo)
        {
            ...
            this.m_HER2ISH = (Interface.IHER2ISH)panelSetOrderCollection.GetPanelSetOrder(reportNo);
        ...
        protected void HandleIHC()
        {
            if (this.m_PanelSetOrderHer2AmplificationByIHC != null && this.m_PanelSetOrderHer2AmplificationByIHC.Final == true)
            {
                if (this.m_PanelSetOrderHer2AmplificationByIHC.Score.Contains("0") || this.m_PanelSetOrderHer2AmplificationByIHC.Score.Contains("1+"))
                {
                    ...
                    this.m_HER2ISH.RecountRequired = false;
                }
                else if (this.m_PanelSetOrderHer2AmplificationByIHC.Score.Contains("2+"))
                {
                    this.m_HER2ISH.RecountRequired = true;
                }
        ...
        public virtual void SetResults(Business.Specimen.Model.SpecimenOrder specimenOrder)
        {
            ...
            if (this.m_HER2ISH.GeneticHeterogeneity == HER2AmplificationByISHGeneticHeterogeneityCollection.GeneticHeterogeneityPresentInCells)
            {
                this.m_InterpretiveComment += Environment.NewLine + Environment.NewLine +
                    ...
                    this.m_HER2ISH.Indicator.ToLower() +
            ...
            else if (this.m_HER2ISH.GeneticHeterogeneity == HER2AmplificationByISHGeneticHeterogeneityCollection.GeneticHeterogeneityPresentInClusters)
            {
                this.m_InterpretiveComment += Environment.NewLine + Environment.NewLine +
                    ...
                    this.m_HER2ISH.Her2Chr17ClusterRatio +
            ...
            this.m_HER2ISH.Result = this.m_Result.ToString();
            this.m_HER2ISH.ResultComment = this.m_ResultComment;
            this.m_HER2ISH.InterpretiveComment = this.m_InterpretiveComment.TrimEnd();
            this.m_HER2ISH.ResultDescription = this.m_ResultDescription;
            this.m_HER2ISH.CommentLabel = null;
            this.m_HER2ISH.ReportReference = this.m_ReportReference;
            this.m_HER2ISH.NoCharge = false;
