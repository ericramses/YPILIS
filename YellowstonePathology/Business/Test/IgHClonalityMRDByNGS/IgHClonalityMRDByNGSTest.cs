...
namespace YellowstonePathology.Business.Test.IgHClonalityMRDByNGS
{
    public class IgHClonalityMRDByNGSTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public IgHClonalityMRDByNGSTest()
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81263"), 1);
