...
namespace YellowstonePathology.Business.Test.HER2AmplificationSummary
{
    ...
    {
        private static string Group2Interpretation =  "Evidence is limited on the efficacy of human epidermal growth factor 2 (HER2)-targeted " +
            "therapy in the small subset of cases with a HER2/chromosome enumeration probe 17 (CEP17) ratio ≥ 2.0 and an average HER2 copy number " +
        ...
        public override void IsAMatch(HER2AmplificationResultMatch her2AmplificationResultMatch)
        {
            if (this.HER2CEP17Ratio >= 2 && this.AverageHER2CopyNo < 4.0)
            {
                ...
                this.m_Interpretation = Group2Interpretation;
