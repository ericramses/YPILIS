...
{
	public class TCellRecepterBetaGeneRearrangementNegativeResult : TCellRecepterBetaGeneRearrangementResult
    {
		public TCellRecepterBetaGeneRearrangementNegativeResult()
		{
