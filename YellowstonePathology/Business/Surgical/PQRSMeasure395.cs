...
namespace YellowstonePathology.Business.Surgical
{
    ...
    {        
        ...
        {            
            ...
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88104"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88108"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88112"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88173"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88305"));

            this.m_PQRSAgeDefinition = PQRSAgeDefinitionEnum.Patients18AndOlder;            

            this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:g9418"));
			this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:g9419"));
			this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:g9420"));
            this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:g9421"));
        }
