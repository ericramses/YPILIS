...
namespace YellowstonePathology.Business.Surgical
{
    ...
    {        
        ...
        {            
            ...
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCode("88104"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCode("88108"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCode("88112"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCode("88173"));
            this.m_CptCodeCollection.Add(Billing.Model.CptCodeCollection.GetCPTCode("88305"));

            this.m_PQRSAgeDefinition = PQRSAgeDefinitionEnum.Patients18AndOlder;            

            this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCode("pqrs:g9418"));
			this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCode("pqrs:g9419"));
			this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCode("pqrs:g9420"));
            this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCode("pqrs:g9421"));
        }
