...
namespace YellowstonePathology.Business.Surgical
{
	public class PQRSBarrettsEsophagusMeasure : PQRSMeasure
	{
		...
		public PQRSBarrettsEsophagusMeasure()
        {
			...
			this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:3126f"));
            this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:3126f1p"));
            this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:g8797"));			
			this.m_PQRSCodeCollection.Add((Billing.Model.PQRSCode)Billing.Model.CptCodeCollection.GetCPTCodeById("pqrs:3126f8p"));			
		}
