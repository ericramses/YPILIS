...
namespace YellowstonePathology.Business.PanelSet.Model
{
	class PanelSetFLT3Retired : PanelSet
	{
		public PanelSetFLT3Retired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81245", null), 1);
