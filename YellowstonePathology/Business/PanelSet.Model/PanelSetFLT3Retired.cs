...
namespace YellowstonePathology.Business.PanelSet.Model
{
	class PanelSetFLT3Retired : PanelSet
	{
		public PanelSetFLT3Retired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:81245"), 1);
