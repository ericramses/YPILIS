...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetMPLRetired : PanelSet
	{
		public PanelSetMPLRetired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Business.Billing.Model.CptCodeCollection.Instance.GetClone("81402", null), 1);
