...
namespace YellowstonePathology.Business.PanelSet.Model
{
	class PanelSetNPM1Retired : PanelSet
	{
        public PanelSetNPM1Retired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81310", null), 1);
