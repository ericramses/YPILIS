...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetMDSByFishRetired : PanelSet
	{
        public PanelSetMDSByFishRetired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("88367"), 10);
