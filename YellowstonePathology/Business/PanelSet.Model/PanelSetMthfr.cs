...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetMthfr : PanelSetMolecularTest
	{
		public PanelSetMthfr()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("81291", null), 1);
