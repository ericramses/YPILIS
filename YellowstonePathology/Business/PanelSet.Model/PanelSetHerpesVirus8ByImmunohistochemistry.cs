...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetHerpesVirus8ByImmunohistochemistry : PanelSet
	{
        public PanelSetHerpesVirus8ByImmunohistochemistry()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("88342"), 1);
