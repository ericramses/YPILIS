...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetArupFactorV : PanelSetMolecularTest
	{
		public PanelSetArupFactorV()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(new YellowstonePathology.Business.Billing.Model.CptCodeDefinition.CPT81241(), 1);
