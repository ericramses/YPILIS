...
namespace YellowstonePathology.Business.PanelSet.Model
{
    public class ShipMaterialTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public ShipMaterialTest()
		{
			...
			this.m_TaskCollection.Add(new YellowstonePathology.Business.Task.Model.TaskFedexShipment(YellowstonePathology.Business.Task.Model.TaskAssignment.Transcription, taskDescription, new Facility.Model.NullFacility()));            
		}
	}
}
