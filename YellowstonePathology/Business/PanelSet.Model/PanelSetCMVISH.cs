...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetCMVISH : PanelSet
	{
        public PanelSetCMVISH()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88365"), 3);
