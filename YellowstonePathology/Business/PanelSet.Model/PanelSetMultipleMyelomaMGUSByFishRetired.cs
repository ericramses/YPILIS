...
namespace YellowstonePathology.Business.PanelSet.Model
{
	class PanelSetMultipleMyelomaMGUSByFishRetired : PanelSet
	{
		public PanelSetMultipleMyelomaMGUSByFishRetired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.GetCPTCode("88367", null), 11);
