...
namespace YellowstonePathology.Business.PanelSet.Model
{
    public class PanelSetIGVH : PanelSet
	{
        public PanelSetIGVH()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Billing.Model.CptCodeCollection.Instance.GetCPTCodeById("CPT81263"), 1);
