...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetBCRABLByPCRRetired : PanelSet
	{
        public PanelSetBCRABLByPCRRetired()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode1 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Business.Billing.Model.CptCodeCollection.Instance.GetClone("81206", null), 1);
            this.m_PanelSetCptCodeCollection.Add(panelSetCptCode1);

            Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Business.Billing.Model.CptCodeCollection.Instance.GetClone("81207", null), 1);
