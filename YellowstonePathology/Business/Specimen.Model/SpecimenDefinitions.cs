...
namespace YellowstonePathology.Business.Specimen.Model.SpecimenDefinition
{
    ...
    public class Peripheral : Specimen
    {
        public Peripheral()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = false;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:85060");
        }
    }
    ...
    public class GenericSpecimenGrossOnly : Specimen
    {
        public GenericSpecimenGrossOnly()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = false;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88300");
        }
    }
    ...
    public class FNA : Specimen
    {
        public FNA()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = true;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88173");
        }
    }
    ...
    public class GIBiopsy : Specimen
    {
        public GIBiopsy()
        {
            ...
            this.m_ClientFixation = "Formalin";
            this.m_RequiresGrossExamination = true;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88305");
        }
    }
    ...
    public class GallbladderExcision : Specimen
    {
        public GallbladderExcision()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = true;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88304");
        }
    }
    ...
    public class BladderTUR : Specimen
    {
        public BladderTUR()
        {
            ...
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88307");
        }
    }
    ...
    public class ProstateRadicalResection : Specimen
    {
        ...
        {            
            ...
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCodeById("cpt:88309");
        }
    }
