...
namespace YellowstonePathology.Business.Specimen.Model.SpecimenDefinition
{
    ...
    public class Urine : Specimen
    {
        public Urine()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = false;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88112", null);
        }
    }
    ...
    public class Peripheral : Specimen
    {
        public Peripheral()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = false;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("85060", null);
        }
    }
    ...
    public class GenericSpecimenGrossOnly : Specimen
    {
        public GenericSpecimenGrossOnly()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = false;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88300", null);
        }
    }
    ...
    public class FNA : Specimen
    {
        public FNA()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = true;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88173", null);
        }
    }
    ...
    public class GIBiopsy : Specimen
    {
        public GIBiopsy()
        {
            ...
            this.m_ClientFixation = "Formalin";
            this.m_RequiresGrossExamination = true;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88305", null);
        }
    }
    ...
    public class GallbladderExcision : Specimen
    {
        public GallbladderExcision()
        {
            ...
            this.m_ClientFixation = null;
            this.m_RequiresGrossExamination = true;
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88304", null);
        }
    }
    ...
    public class BladderTUR : Specimen
    {
        public BladderTUR()
        {
            ...
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88307", null);
        }
    }
    ...
    public class ProstateRadicalResection : Specimen
    {
        ...
        {            
            ...
            this.m_CPTCode = Billing.Model.CptCodeCollection.GetCPTCode("88309", null);
        }
    }
