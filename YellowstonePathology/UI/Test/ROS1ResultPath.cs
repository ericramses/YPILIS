...
namespace YellowstonePathology.UI.Test
{
    public class ROS1ResultPath : ResultPath
    {
        ...
        protected override void ShowResultPage()
        {
            ...
            this.m_ROS1ResultPage.CPTCode += ResultPage_CPTCode;
        ...
        {
            Billing.AddFISHCPTCodePage addCPTCodePage = new Billing.AddFISHCPTCodePage(this.m_ROS1ByFISHTestOrder.ReportNo, this.m_AccessionOrder);
