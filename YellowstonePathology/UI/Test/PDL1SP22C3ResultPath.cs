...
{
    public class PDL1SP22C3ResultPath : ResultPath
    {
        PDL1SP22C3ResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3.PDL122C3TestOrder m_PanelSetOrder;

        public PDL1SP22C3ResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3.PDL122C3TestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL1SP22C3ResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL1SP22C3ResultPage.NextEventHandler(ResultPage_Next);
