...
{
    public class RedisServerDeprecated : IRedisServer
    {
        private static RedisServerDeprecated instance = null;
        ...
        public static RedisServerDeprecated Instance
        {
            get
            {
                lock (padlock)
                {
                    if (instance == null)
                    {
                        instance = new RedisServerDeprecated();
                    }
                    return instance;
                }
            }
