...
{
	public class IntraoperativeConsultationResultSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.IntraoperativeConsultationResultSchema.xsd";
