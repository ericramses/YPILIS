...
{
	public class TestSpecimenOrderSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.TestSpecimenOrderSchema.xsd";
