...
{
	public class SurgicalBillingSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.SurgicalBillingSchema.xsd";
