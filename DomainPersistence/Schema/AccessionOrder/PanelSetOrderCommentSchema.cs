...
{
	public class PanelSetOrderCommentSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.AccessionOrder.PanelSetOrderCommentSchema.xsd";
