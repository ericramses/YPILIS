...
{
	public class ErPrSemiQuantitativeResultSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.ErPrSemiQuantitativeResultSchema.xsd";
