...
{
	public class ClientLocationSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.SingleItemSchema.ClientLocationSchema.xsd";
