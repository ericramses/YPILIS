...
{
	public class AccessionSlideOrderViewSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.SingleItemSchema.AccessionSlideOrderViewSchema.xsd";
