...
{
	public class ClientOrderDetailSchema
	{
		private static XDocument instance;
		private const string SchemaPath = "YellowstonePathology.Business.Domain.Persistence.Schema.SingleItemSchema.ClientOrderDetailSchema.xsd";
