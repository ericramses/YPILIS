...
{
	public class PanelSetTCellClonalityByPCR : PanelSet
	{
        public PanelSetTCellClonalityByPCR()
		{
			...
			this.m_PanelSetOrderClassName = typeof(YellowstonePathology.Business.Test.PanelSetOrderTCellClonalityByPCR).AssemblyQualifiedName;
