...
{
	public class PanelSetMPNFishPanel : PanelSet
	{
        public PanelSetMPNFishPanel()
		{
			...
			this.m_PanelSetOrderClassName = typeof(YellowstonePathology.Business.Test.PanelSetOrderMPNFish).AssemblyQualifiedName;
