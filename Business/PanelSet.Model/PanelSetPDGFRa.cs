...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetPDGFRa : PanelSet
	{
        public PanelSetPDGFRa()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(new YellowstonePathology.Business.Billing.Model.CptCodeDefinition.CPT88374(), 1);
