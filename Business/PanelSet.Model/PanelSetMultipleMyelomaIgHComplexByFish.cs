...
{
	public class PanelSetMultipleMyelomaIgHComplexByFish : PanelSet
	{
        public PanelSetMultipleMyelomaIgHComplexByFish()
		{
			...
			this.m_PanelSetOrderClassName = typeof(YellowstonePathology.Business.Test.PanelSetOrderMultipleMyelomaIgHComplexByFish).AssemblyQualifiedName;
