...
namespace YellowstonePathology.Business.Label.Model
{
    public class HistologySlidePaperLabel : Label
    {
        ...
        public HistologySlidePaperLabel(string slideOrderId, string reportNo, string slideNumber, string patientLastName, string testAbbreviation, string facilityLocationAbbreviation)
        {
