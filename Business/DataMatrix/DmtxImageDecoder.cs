...
namespace YellowstonePathology.Business.DataMatrix
{
    ...
    {
        /// <summary>
        /// returns a list of all decoded YellowstonePathology.Business.DataMatrix codes in the image provided
        /// </summary>
        ...
        /// <summary>
        /// returns a list of YellowstonePathology.Business.DataMatrix codes in the image provided that can be
