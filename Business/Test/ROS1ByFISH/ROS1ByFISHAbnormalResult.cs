...
{
    public class ROS1ByFISHAbnormalResult : ROS1ByFISHResult
	{
        public ROS1ByFISHAbnormalResult()
		{            
            this.m_ResultCode = "ROS1FISHBNRL";
			this.m_Result = "Abnormal";
            this.m_ResultDisplayText = "Abnormal";
            this.m_ResultAbbreviation = "Abnormal";
