...
namespace YellowstonePathology.Business.Test.Surgical
{
	...
	{
        public SurgicalWordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
		...
		{						
			...
			this.m_TemplateName = @"\\Cfileserver\Documents\ReportTemplates\XmlTemplates\Surgical.7.xml";
