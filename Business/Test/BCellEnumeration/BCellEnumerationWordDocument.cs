...
namespace YellowstonePathology.Business.Test.BCellEnumeration
{
	...
	public class BCellEnumerationWordDocument : YellowstonePathology.Business.Document.CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			this.ReplaceText("report_wbc", testOrder.WBC.ToString());
			this.ReplaceText("report_lymphocyte_percentage", testOrder.LymphocytePercentage.ToString().StringAsPercent());
			this.ReplaceText("report_cd19_bcel_positive_count", testOrder.CD19BCellPositiveCount.ToString());
			this.ReplaceText("report_cd19_bcell_positive_percent", testOrder.CD19BCellPositivePercent.ToString().StringAsPercent());
			this.ReplaceText("report_cd20_bcell_positive_count", testOrder.CD20BCellPositiveCount.ToString());
			this.ReplaceText("report_cd20_bcell_positive_percent", testOrder.CD20BCellPositivePercent.ToString().StringAsPercent());
			this.ReplaceText("report_cd19_absolute_count", testOrder.CD19AbsoluteCount.ToString());
			this.ReplaceText("report_cd20_absolute_count", testOrder.CD20AbsoluteCount.ToString());
