...
namespace YellowstonePathology.Business.Test.PDL1
{
    ...
    {
        public PDL1WordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
