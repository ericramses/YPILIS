...
namespace YellowstonePathology.Business.Test.KRASExon23Mutation
{
    ...
    {
        public KRASExon23MutationWordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
        ...
        {            
            ...
            this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\KRASExon23Mutation.xml";
            base.OpenTemplate();
