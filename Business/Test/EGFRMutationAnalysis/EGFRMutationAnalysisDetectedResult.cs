...
namespace YellowstonePathology.Business.Test.EGFRMutationAnalysis
{
    public class EGFRMutationAnalysisDetectedResult : EGFRMutationAnalysisResult
    {
        public EGFRMutationAnalysisDetectedResult()
        {
            ...
            this.m_Indication = "Screening for EGFR mutations may help identify patients with tumors that will benefit from the use of EGFR " +
                "tyrosine kinase inhibitors (TKIs).  Mutations may be activating and indicate responsiveness to TKIs or it may be a resistance mutation indicating a lack of " +
                "response to TKIs.  A product indicative of an activating EGFR mutation was detected.  This type of mutation has been correlated with responsiveness to TKI therapy. ";
