...
namespace YellowstonePathology.Business.Test.Autopsy
{
	...
	{
        public AutopsyWordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
