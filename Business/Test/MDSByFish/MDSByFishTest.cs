...
{
	public class PanelSetMDSByFish : PanelSet
	{
        public PanelSetMDSByFish()
		{
			...
			this.m_PanelSetOrderClassName = typeof(YellowstonePathology.Business.Test.PanelSetOrderMDSByFish).AssemblyQualifiedName;
