...
namespace YellowstonePathology.Business.Test.PNH
{
	...
	{
        public PNHWordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
