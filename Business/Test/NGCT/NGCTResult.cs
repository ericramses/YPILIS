...
namespace YellowstonePathology.Business.Test.NGCT
{
	public class NGCTResult : YellowstonePathology.Business.Test.TestResult
	{
        ...
        public static string References = "Whiley DM.  Comparison of three in-house multiplex PCR assays for the detection of Neisseria gonorrhoeae and Chlamydia trachomatis " +
                "using real-time and conventional detection methodologies. Pathology (October 2005) 37(5), pp. 364–370.";
        public static string TestDevelopment = "This test was developed and its performance characteristics determined by Yellowstone Pathology Institute, Inc.  It has not " +
