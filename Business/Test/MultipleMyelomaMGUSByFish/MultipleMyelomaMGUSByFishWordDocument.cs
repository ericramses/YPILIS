...
namespace YellowstonePathology.Business.Test.MultipleMyelomaMGUSByFish
{
	...
	{
        public MultipleMyelomaMGUSByFishWordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
		...
		{			
			...
			this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\MultipleMyelomaMGUSByFish.xml";
			base.OpenTemplate();
