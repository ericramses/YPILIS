...
{
	public class HPVTWIHighCVResult : HPVTWIResult
	{
		public HPVTWIHighCVResult()
		{
            this.m_PreliminaryResultCode = "HPVTWHGHCV";
            this.m_A5A6Result = HPVTWIResult.HighCVResult;
            this.m_A7Result = HPVTWIResult.HighCVResult;
            this.m_A9Result = HPVTWIResult.HighCVResult;

            this.m_OveralResultCode = "HPVTWIINSFCTDNA";
