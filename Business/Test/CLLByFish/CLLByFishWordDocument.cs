...
namespace YellowstonePathology.Business.Test.CLLByFish
{
	...
	{
        public CLLByFishWordDocument(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
