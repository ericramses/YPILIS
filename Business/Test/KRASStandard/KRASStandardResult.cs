...
namespace YellowstonePathology.Business.Test.KRASStandard
{
	...
	{        
		...
		public virtual void FinalizeResults(KRASStandardTestOrder panelSetOrder,
			YellowstonePathology.Business.User.SystemIdentity systemIdentity)
		{
			panelSetOrder.Finalize(systemIdentity.User);
		}

		public virtual void UnFinalizeResults(KRASStandardTestOrder panelSetOrder)
		{
			panelSetOrder.Unfinalize();
		}

		public virtual void AcceptResults(KRASStandardTestOrder panelSetOrder, YellowstonePathology.Business.Test.PanelOrder panelToAccept, YellowstonePathology.Business.User.SystemIdentity systemIdentity)
		{
		...
		public virtual void UnacceptResults(KRASStandardTestOrder panelSetOrder)
		{
		...
		public static YellowstonePathology.Business.Rules.MethodResult IsOkToFinal(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, YellowstonePathology.Business.Test.KRASStandard.KRASStandardTestOrder panelSetOrder)
		{
			YellowstonePathology.Business.Rules.MethodResult result = panelSetOrder.IsOkToFinalize();
			if(result.Success == true)
			{
				...
				if (accessionOrder.PanelSetOrderCollection.Exists(krasStandardReflexTest.PanelSetId, panelSetOrder.OrderedOnId, true) == false)
				{
                    ...
                    if (panelSetOrder.TechnicalComponentFacilityId == ypi.FacilityId)
                    {                                                
                        if (string.IsNullOrEmpty(panelSetOrder.TumorNucleiPercentage) == true)
                        {
		...
		public static YellowstonePathology.Business.Rules.MethodResult IsOkToAccept(KRASStandardTestOrder testOrder)
		{
		...
		public static YellowstonePathology.Business.Rules.MethodResult IsOkToUnaccept(KRASStandardTestOrder panelSetOrder)
		{
			YellowstonePathology.Business.Rules.MethodResult result = panelSetOrder.IsOkToUnaccept();
			return result;
		}

		public static YellowstonePathology.Business.Rules.MethodResult IsOkToSetResult(KRASStandardTestOrder panelSetOrder)
		{
