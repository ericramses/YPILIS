...
{
	public class MultipleMyelomaIgHByFishReport : CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			YellowstonePathology.Business.Test.PanelSetOrderMultipleMyelomaIgHComplexByFish panelSetOrderMultipleMyelomaIgHByFish = (YellowstonePathology.Business.Test.PanelSetOrderMultipleMyelomaIgHComplexByFish)this.m_PanelSetOrder;
