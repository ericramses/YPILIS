...
{
	public class MDSExtendedByFishReport : CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			YellowstonePathology.Business.Test.PanelSetOrderMDSExtendedByFish panelSetOrderMDSExtendedPanelByFish = (YellowstonePathology.Business.Test.PanelSetOrderMDSExtendedByFish)this.m_PanelSetOrder;
