...
namespace YellowstonePathology.Business.Document
{
    ...
    {
        public NothingToPublishReport(Business.Test.AccessionOrder accessionOrder, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
