...
{
	public class NPM1Report : CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			YellowstonePathology.Business.Test.PanelSetOrderNPM1 panelSetOrderNPM1 = (YellowstonePathology.Business.Test.PanelSetOrderNPM1)this.m_PanelSetOrder;
