...
{
	public class MPNFishReport : CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			YellowstonePathology.Business.Test.PanelSetOrderMPNFish panelSetOrderMPNFish = (YellowstonePathology.Business.Test.PanelSetOrderMPNFish)this.m_PanelSetOrder;
