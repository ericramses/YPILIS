...
{
	public class MultipleFISHProbePanelReport : CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			YellowstonePathology.Business.Test.PanelSetOrderMultipleFISHProbePanel panelSetOrderMultipleFISHProbePanel = (YellowstonePathology.Business.Test.PanelSetOrderMultipleFISHProbePanel)this.m_PanelSetOrder;
