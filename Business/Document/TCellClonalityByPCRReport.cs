...
{
	public class TCellClonalityByPCRReport : CaseReportV2
	{
		public override void Render(string masterAccessionNo, string reportNo, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveEnum)
		{
			...
			YellowstonePathology.Business.Test.PanelSetOrderTCellClonalityByPCR panelSetOrderTCellClonalityByPCR = (YellowstonePathology.Business.Test.PanelSetOrderTCellClonalityByPCR)this.m_PanelSetOrder;
