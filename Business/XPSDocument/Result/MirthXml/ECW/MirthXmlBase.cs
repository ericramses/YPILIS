...
namespace YellowstonePathology.Document.Result.MirthXml.ECW
{
	...
	public abstract class MirthXmlBase : XDocument
	{
		...
		private void AddObxSegmentsForAmendment(XElement amendment)
		{
			...
			AddObxSegmentsForSection(amendment.GetStringValue(YpReportDataBase.AmendmentText));
		...
		/// </summary>
		/// <param name="reportDistributions">XML elements list for "ReportDistribution" section</param>
		private void AddReportDistributionObxSegments(IEnumerable<XElement> reportDistributions)
		{
		...
		private void AddNteSegments(XElement headerData)
		{
			XElement nte = new XElement("NTE");
			XElement nte1 = new XElement("NTE.1",
				new XElement("NTE.1.1", "1"),
				new XElement("NTE.1.2", "L"),
				new XElement("NTE.1.3", "Patient:" +  headerData.GetStringValue("PLastName") + ", " + headerData.GetStringValue("PFirstName")));
			nte.Add(nte1);


			XElement nte2 = new XElement("NTE.1",
				new XElement("NTE.1.1", "2"),
				new XElement("NTE.1.2", "L"),
				new XElement("NTE.1.3", "Specimen :" +  headerData.GetStringValue("PLastName") + ", " + headerData.GetStringValue("PFirstName")));
			nte.Add(nte2);

			XElement nte3 = new XElement("NTE.1",
				new XElement("NTE.1.1", "3"),
				new XElement("NTE.1.2", "L"),
				new XElement("NTE.1.3", "Diagnosis:" +  headerData.GetStringValue("PLastName") + ", " + headerData.GetStringValue("PFirstName")));
			nte.Add(nte3);
	
			XElement nte4 = new XElement("NTE.1",
				new XElement("NTE.1.1", "4"),
				new XElement("NTE.1.2", "L"),
				new XElement("NTE.1.3", "Comment:" +  headerData.GetStringValue("PLastName") + ", " + headerData.GetStringValue("PFirstName")));
			nte.Add(nte4);
			
			XElement nte5 = new XElement("NTE.1",
				new XElement("NTE.1.1", "5"),
				new XElement("NTE.1.2", "L"),
				new XElement("NTE.1.3", "Pathologist:" +  headerData.GetStringValue("PLastName") + ", " + headerData.GetStringValue("PFirstName")));
			nte.Add(nte5);
			m_Root.Add(nte);
			

			/*nte.AddChildElement().AddChildHl7Element("NTE.1.1", "1");
			XElement nte2 = nte.AddChildElement("NTE.2");
			nte3.AddChildHl7Element("NTE.3.1", "TX");
			nte3.AddChildHl7Element("NTE.3.2", m_FillerOrderCode);
			XElement nte4 = nte.AddChildElement("OBR.4");
			nte4.AddChildHl7Element("NTE.4.1", m_UniversalServiceIdentifier);
			nte4.AddChildHl7Element("NTE.4.2", m_UniversalServiceIdentifierText);
			nte.AddChildElement("NTE.7").AddChildHl7Element("OBR.7.1", m_RequestedDateTime.ToString("yyyyMMddHHmm"));
			nte.AddChildElement("NTE.14").AddChildHl7Element("OBR.14.1", m_SpecimenReceivedDateTime.ToString("yyyyMMddHHmm"));
			nte.AddChildElement("NTE.22").AddChildHl7Element("OBR.22.1", m_ResultsDateTime.ToString("yyyyMMddHHmm"));
			nte.AddChildElement("NTE.25").AddChildHl7Element("OBR.25.1", "F");
			XElement obr32 = nte.AddChildElement("OBR.32");
			nte32.AddChildHl7Element("NTE.32.1", m_PrincipalResultInterpreterID);
			nte32.AddChildHl7Element("NTE.32.2", m_PrincipalResultInterpreterLastName);
			nte32.AddChildHl7Element("NTE.32.3", m_PrincipalResultInterpreterFirstName);
			nte32.AddChildHl7Element("NTE.32.9", m_PrincipalResultInterpreterAssigningAuthority);
			nte32.AddChildHl7Element("NTE.32.13", m_PrincipalResultInterpreterIdentifierTypeCode);
			m_Root.Add(nte);*/
		}
