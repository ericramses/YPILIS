...
{
	/// <summary>Mirth HL7 data for High Risk HPV Testing report
	/// </summary>
	public class OruHpvTwi : MirthXmlBase
	{

		#region Private data
		/// <summary>report XML data
		/// </summary>
		private readonly HpvTwiReportData m_Data;
		...
		public OruHpvTwi(HpvTwiReportData data)
			: base(HpvTwiReport.ReportName, data.PageHeader)
		{
			m_Data = data;
			AddCustomObxSegments();
			AddObxSegmentsForStandardTrailerSections(data.OtherReportsText, data.ReportDistributionList, HpvTwiReport.DisclaimerIndex);
		}
		...
		private void AddCustomObxSegments()
		{
			...
			AddObxSegmentsForHeaderSection(HpvTwiReport.TestInformationLabel, m_Data.TestInformationText);
		}
