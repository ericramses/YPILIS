...
namespace YellowstonePathology.Business.HL7View.CMMC
{
	...
	{        
        ...
        public CMMCObrView(string externalOrderId, string ypiOrderId, Nullable<DateTime> collectionTime, Nullable<DateTime> accessionTime, Nullable<DateTime> finalTime, 
        ...
        public void ToXml(XElement document)
        {
            ...
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.4.1", "YPI", obr04Element);
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.4.2", "Pathology Procedure/Specimen", obr04Element);             
            obrElement.Add(obr04Element);

            if (this.m_CollectionTime.HasValue == true)
            {
                XElement obr07Element = new XElement("OBR.7");
                YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.7.1", this.m_CollectionTime.Value.ToString(m_DateFormat), obr07Element);
