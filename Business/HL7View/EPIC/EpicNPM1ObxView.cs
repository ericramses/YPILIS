...
{
	public class EpicNPM1ObxView : EpicObxView
	{
		public EpicNPM1ObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
		...
		{
			YellowstonePathology.Business.Test.PanelSetOrderNPM1 panelSetOrder = (YellowstonePathology.Business.Test.PanelSetOrderNPM1)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
