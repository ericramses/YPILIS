...
{
	public class EpicMPNFishObxView : EpicObxView
	{
		public EpicMPNFishObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
		...
		{
			YellowstonePathology.Business.Test.PanelSetOrderMPNFish panelSetOrder = (YellowstonePathology.Business.Test.PanelSetOrderMPNFish)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
