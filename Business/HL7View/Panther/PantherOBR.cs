...
namespace YellowstonePathology.Business.HL7View.Panther
{
	...
	{        
        ...
        public PantherOBR(string externalOrderId, string masterAccessionNo, string reportNo, Nullable<DateTime> collectionDate, Nullable<DateTime> collectionTime, Nullable<DateTime> accessionTime, Nullable<DateTime> finalTime,
