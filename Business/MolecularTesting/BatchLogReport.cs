...
{
    public class BatchLogReport
    {
        public BatchLogReport()
        {

        }

		public void Print(YellowstonePathology.Business.Search.ReportSearchList caseList, YellowstonePathology.Business.Panel.Model.PanelOrderBatch panelOrderBatch)
		{            
            Microsoft.Office.Interop.Excel.Application xlApp;
            xlApp = new Microsoft.Office.Interop.Excel.Application();
            xlApp.Visible = false;

            Microsoft.Office.Interop.Excel.Workbook wb = xlApp.Workbooks.Add(@"\\CFileServer\documents\ReportTemplates\MolecularTesting\BatchLog.xlt");
            Microsoft.Office.Interop.Excel.Worksheet ws = (Microsoft.Office.Interop.Excel.Worksheet)wb.Worksheets[1];                                   

            ws.Cells[3, 1] = "Batch: " + panelOrderBatch.Description + " - " + panelOrderBatch.BatchDate.Value.ToShortDateString();            
            ...
            for (int i = caseList.Count - 1; i > -1; i--)
            {
                ...
                ws.Cells[rowPosition, 2] = caseList[i].ForeignAccessionNo;
