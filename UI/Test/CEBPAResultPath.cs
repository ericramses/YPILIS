...
namespace YellowstonePathology.UI.Test
{
	public class CEBPAResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.CEBPA.CEBPATestOrder m_PanelSetOrder;
            ...
            : base(pageNavigator)
        {
			...
			this.m_PanelSetOrder = (YellowstonePathology.Business.Test.CEBPA.CEBPATestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
