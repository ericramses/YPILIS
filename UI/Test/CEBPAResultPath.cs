...
namespace YellowstonePathology.UI.Test
{
	public class CEBPAResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.PanelSetOrderCEBPA m_PanelSetOrder;
            ...
            : base(pageNavigator)
        {
			...
			this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PanelSetOrderCEBPA)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
