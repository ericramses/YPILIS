...
namespace YellowstonePathology.UI.Test
{
    public class ROS1ResultPath : ResultPath
    {
        ...
        {
            this.m_ROS1ResultPage = new ROS1ResultPage(this.m_ROS1ByFISHTestOrder, this.m_AccessionOrder, this.m_ObjectTracker, this.m_SystemIdentity);
        ...
        private bool ShowReflexTestPage()
        {
            ...
            if (this.m_AccessionOrder.PanelSetOrderCollection.Exists(panelSet.PanelSetId, this.m_ROS1ByFISHTestOrder.OrderedOnId, true) == true)
            {
				...
				result = true;
				Test.EGFRToALKReflexPath egfrToALKReflexPath = new Test.EGFRToALKReflexPath(testOrder.ReportNo, this.m_AccessionOrder, this.m_ObjectTracker, this.m_SystemIdentity, this.m_PageNavigator, System.Windows.Visibility.Visible);
