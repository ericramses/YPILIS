...
namespace YellowstonePathology.UI.Test
{
	public class MultipleFISHProbePanelResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.PanelSetOrderMultipleFISHProbePanel m_PanelSetOrder;
            ...
            : base(pageNavigator)
        {
			...
			this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PanelSetOrderMultipleFISHProbePanel)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
