...
namespace YellowstonePathology.UI.Test
{
	public class MultipleFISHProbePanelResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.MultipleFISHProbe.PanelSetOrderMultipleFISHProbePanel m_PanelSetOrder;
        ...
        {
			this.m_ResultPage = new MultipleFISHProbePanelResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
