	...
	public class HPVResultPath : ResultPath
	{
		...
		private bool ShowWomensHealthProfilePage()
		{
			...
			if (this.m_AccessionOrder.PanelSetOrderCollection.HasWomensHealthProfileOrder() == true)
			{
				...
				YellowstonePathology.Business.ClientOrder.Model.ClientOrder clientOrder = YellowstonePathology.Business.Persistence.ObjectGatway.Instance.GetClientOrderByClientOrderId(this.m_AccessionOrder.ClientOrderId);
