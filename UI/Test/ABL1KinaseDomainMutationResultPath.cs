...
{
	public class ABL1KinaseDomainMutationResultPath : ResultPath
	{
		ABL1KinaseDomainMutationResultPage m_ResultPage;
		YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
		YellowstonePathology.Business.Test.ABL1KinaseDomainMutation.ABL1KinaseDomainMutationTestOrder m_PanelSetOrder;
        ...
        {
			this.m_ResultPage = new ABL1KinaseDomainMutationResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
