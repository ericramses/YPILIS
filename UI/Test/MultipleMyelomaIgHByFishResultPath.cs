...
namespace YellowstonePathology.UI.Test
{
	public class MultipleMyelomaIgHByFishResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.PanelSetOrderMultipleMyelomaIgHComplexByFish m_PanelSetOrder;
            ...
            : base(pageNavigator)
        {
			...
			this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PanelSetOrderMultipleMyelomaIgHComplexByFish)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
