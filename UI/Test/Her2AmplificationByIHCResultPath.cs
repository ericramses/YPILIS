...
namespace YellowstonePathology.UI.Test
{
	public class Her2AmplificationByIHCResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.PanelSetOrderHer2AmplificationByIHC m_PanelSetOrder;
			...
			: base(pageNavigator)
		{
			...
			this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PanelSetOrderHer2AmplificationByIHC)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
