...
namespace YellowstonePathology.UI.Test
{
	public class Her2AmplificationByFishResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.Her2AmplificationByFish.Her2AmplificationByFishTestOrder m_PanelSetOrder;
            ...
            : base(pageNavigator)
        {
			...
			this.m_PanelSetOrder = (YellowstonePathology.Business.Test.Her2AmplificationByFish.Her2AmplificationByFishTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
