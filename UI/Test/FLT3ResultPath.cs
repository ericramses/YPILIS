...
namespace YellowstonePathology.UI.Test
{
	public class FLT3ResultPath : ResultPath
	{
		...
		YellowstonePathology.Business.Test.PanelSetOrderFLT3 m_PanelSetOrderFLT3;
            ...
            : base(pageNavigator)
        {
			...
			this.m_PanelSetOrderFLT3 = (YellowstonePathology.Business.Test.PanelSetOrderFLT3)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
