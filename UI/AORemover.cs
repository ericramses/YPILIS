...
namespace YellowstonePathology.UI
{
    public class AORemover
    {
        ...
        public void Remove(Business.Test.AccessionOrder accessionOrder, object writer)
        {
            ...
            YellowstonePathology.Business.ClientOrder.Model.ClientOrder clientOrder = YellowstonePathology.Business.Persistence.DocumentGateway.Instance.PullClientOrderByClientOrderId(accessionOrder.ClientOrderId, writer);
